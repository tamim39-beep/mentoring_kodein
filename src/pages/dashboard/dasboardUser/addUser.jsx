...
const addUserSchema = z.object({
  ...
  username: z
    .string()
    .min(5, { message: "Username harus minimal 5 karakter" }),
  password: z
    .string()
    .min(5, { message: "Password harus minimal 5 karakter" }),
  email: z
  ...
  role: z
    .enum(["user", "admin"], { message: "Role tidak valid" })
});
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-black! text-base">Nama Lengkap</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-black! text-base">Nomor Telepon</FormLabel>
              <FormControl>
